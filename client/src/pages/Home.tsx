...
export default function Home() {
  ...
  const getRandomTitle = useCallback((currentKey: string | null): { item: TitleItem; key: string } => {
    const titlesData = t('home.titles', { returnObjects: true }) as Record<string, TitleItem>;
